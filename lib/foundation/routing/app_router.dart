...
import 'package:beedle/features/today/presentation/screens/today.screen.dart';
...
///
/// Exposé comme singleton [instance] pour permettre les deep-links hors widget
/// tree (notification handlers, URL schemes).
@AutoRouterConfig(replaceInRouteName: 'Screen|Page,Route')
class AppRouter extends RootStackRouter {
  AppRouter({super.navigatorKey});

  /// Singleton global — utilisé par les deep-link handlers (bootstrap).
